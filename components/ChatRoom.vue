<template>
	<div class="chat-window">
		...
		<form class="input-container" v-on:submit="sendMessage">
			...
			<!-- Bind it to msg down in script using event listener-->
...
export default {
	...
	methods: {
		sendMessage: function () {
			...
			this.$emit('sendMessage', this.msg); // Send this message
			this.msg = ""; // Make Input field empty again
		}
	}
}
</script>
...
.chat-window {
	flex: 1; // We want chatroom to take rest of the room on the page
	display: flex; 
